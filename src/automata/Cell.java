...
abstract public class Cell {
    ...
    /**
     * The list of possible states for the cell.
     * With this reference, we can build a transition function.
     */
     ...
     * This attribute is used because all the cells have to
     * check their next state (via neighbours) before
     * one can be changed.
     */
    protected State saveState;
    
    /**
     * The eight neighbours of the cell.
     * To avoid searching neighbours of the cell
     * at each generation, this attribute stores them.
     */
    ...
    /**
     * Gives birth to the cell.
     * Updates its first state and saves it.
     * 
     * @see Cell#initState() 
     */
    ...
    /**
     * Restarts the cell.
     * As the only thing that evolves in the cell is its status, this
     * method only set the current state to the firstState.
     */
    ...
    /**
     * Saves the next state of the cell.
     * First, all cells check their next state and save it.
     * Then, all cells adopt their new states.
     * 
     * @see Cell#saveState
     */
    ...
    /**
     * Changes the state of the cell, according to "saveState".
     * Once all cells know their future state, they can update.
     * 
     * @see Cell#saveState
     */
    ...
    /**
     * Finds the eight neighbours of the cell.
     * As long as the grid is circular, a cell will
     * always have eight neighbours.
     */
    ...
    /**
     * Counts the number of neighbouring cells in the state "state".
     * If the state is null, throws an IllegalArgumentException.
     * 
     ...
     * 
     * This method is not intended to assign the future state.
     * It's the "transition function" of the automaton.
     * 
