...
abstract public class Automaton implements Simulable {
	...
	/**
	 * Begins the simulation by creating the window. Here, the GUI and the automaton
	 * are fully dependent.
	 * 
	 ...
	 * function would return an array
	 * 
	 * [ new State("Alive"), new State("Dead") ]
	 * 
	 * in Conway's game of life. The states may depend on parameters according to
	 * the automaton, so this method will be called in child classes only.
	 * 
	 ...
	 * 
	 * Each automaton child should override this method and return the class that
	 * will represent its cells. For example, the method
	 ...
	 * 
	 * @param i
	 *            The x-position of the new cell
	 * @param j
	 *            The y-position of the new cell
