...
import boids.rules.BoidA;
import boids.rules.Rule;

// JE VAIS M'EN INSPIRER POUR BOIDSYSTEM
// NE PAS TOUCHER POUR LE MOMENT THX :)
...
public class BoidSimulator implements Simulable {
    ...
    public BoidSimulator(GUISimulator gui, int boidsNumber) {
        this.boids = new ArrayList<BoidA>();
        for (int i = 0; i < boidsNumber; i++) {
            this.boids.add(new BoidA(gui.getPanelWidth(), gui.getPanelHeight()));
        }
