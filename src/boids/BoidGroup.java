...
public class BoidGroup {
	...
	/**
	 * Creates a flock with a given number of boid, that can be placed in a frame
	 * given its width and height. Each flock has its own delay, which is used to
	 * slow down the speed of the group.
	 *
	 * @param numberOfBoids
	 * @param width
	 * @param height
