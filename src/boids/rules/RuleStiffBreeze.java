...
/**
 * Represents a rule where a breeze constraints boids movements. Useful to
 * create winds, water flows, etc.
 *
 * The force of the breeze is a scale between -10 and 10. There is two scales :
 * a vertical one and an horizontal one.
 *
