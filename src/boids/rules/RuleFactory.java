...
public class RuleFactory {
	...
	/**
	 * This rule creation method only creates the three basic rules for the flocks
	 * and flocks.
	 * 
	 * @param ruleName
	 *            the rule to create
	 * @param flock
	 *            the flock on which the rule is applied
	 * @param distance
	 *            the maximum distance of the rule application
